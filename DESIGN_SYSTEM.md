...
## 36. Unified Sub-Screen Architecture & Creation Standards (Categories & Payment Options)

### 36.1 Structural Harmonization & Minimal Cognitive Load
...
4. **Inline Quick-Add Card**:
   ...
   - Provides natural in-flow creation without visual clutter.
5. **Unified Single Divided Card Container**:
...
- **Home Screen Composition**: The home screen layout is strictly focused on financial intelligence:
  1. `BalanceCard` (Net Liquidity & Cash Flow)
