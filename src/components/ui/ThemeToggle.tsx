...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        'group relative inline-flex h-8 w-[66px] shrink-0 cursor-pointer items-center rounded-full bg-slate-200 dark:bg-slate-800 p-1 transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 focus-visible:ring-offset-theme-app disabled:cursor-not-allowed disabled:opacity-[0.38] disabled:pointer-events-none active:scale-[0.96]',
        className
      )}
    >
      ...
      <span
        className={cn(
          'pointer-events-none absolute top-[4px] flex size-6 items-center justify-center rounded-full shadow-md transition-all duration-200 ease-out',
          isDark
            ? 'translate-x-[34px] bg-violet-600 text-white shadow-violet-950/50'
