...
export const BalanceCard: React.FC<BalanceCardProps> = ({
  ...
  return (
    <div className="rounded-3xl bg-gradient-to-br from-violet-600/60 via-violet-500/20 to-emerald-500/30 p-px shadow-xl shadow-violet-950/40">
      <div className="rounded-[calc(1.5rem-1px)] bg-slate-900 p-5">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3">
          ...
          <div className="flex items-center gap-2.5 rounded-2xl bg-emerald-500/10 px-3 py-2.5">
            ...
            <div className="leading-tight min-w-0">
              <p className="text-[11px] text-emerald-300/70">Income</p>
              <p className="text-sm font-semibold text-emerald-300 tabular-nums truncate">
          ...
          <div className="flex items-center gap-2.5 rounded-2xl bg-rose-500/10 px-3 py-2.5">
            <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-rose-500/20 text-rose-400">
              <ArrowUpRight className="size-4" />
            </span>
            <div className="leading-tight min-w-0">
              <p className="text-[11px] text-rose-300/70">Spent</p>
              <p className="text-sm font-semibold text-rose-300 tabular-nums truncate">
