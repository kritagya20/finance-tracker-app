  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar min-h-0 px-5 py-4 space-y-4">
        ...
        <div className="pt-2">
          <a
            href="mailto:support@antigravity.finance?subject=Finance%20App%20Support"
            className="flex items-center justify-between p-3.5 rounded-2xl border border-theme-border bg-theme-card hover:bg-theme-card-hover transition-colors"
          >
            <div className="flex items-center gap-3">
              <div className="flex size-9 items-center justify-center rounded-xl bg-theme-card-subtle text-theme-secondary">
                <Mail className="size-4" />
              </div>
              <div>
                <p className="text-xs font-semibold text-theme-primary">Email Developer Support</p>
                <p className="text-[10px] text-theme-muted">Replies typically within 24 hours</p>
              </div>
            </div>
            <ExternalLink className="size-4 text-theme-muted" />
          </a>
        </div>
      </div>
